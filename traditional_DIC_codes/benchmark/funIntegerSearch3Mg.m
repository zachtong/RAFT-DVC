...
switch fftmethod
    ...
    case {'bigphasecorr','bigxcorr'}
        ...
        uGrid    = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),tempu(indxyz),  xGrid,yGrid,zGrid); waitbar(1/6);
        vGrid    = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),tempv(indxyz),  xGrid,yGrid,zGrid); waitbar(2/6);
        wGrid    = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),tempw(indxyz),  xGrid,yGrid,zGrid); waitbar(3/6);
        PhiGrid  = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),tempPhi(indxyz),xGrid,yGrid,zGrid); waitbar(4/6);
        qf_1Grid = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),qf_1(indxyz),   xGrid,yGrid,zGrid); waitbar(5/6);
        qf_2Grid = local_scatterToGrid(tempx(indxyz),tempy(indxyz),tempz(indxyz),qf_2(indxyz),   xGrid,yGrid,zGrid); waitbar(6/6);
        % ============== END HEADLESS PATCH ==================================
