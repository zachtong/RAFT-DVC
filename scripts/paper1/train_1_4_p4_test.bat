...
REM
REM Test config: standard CorrBlock + batch=8 + 50 epochs (FAST iteration)
REM   - Same as 1/8's basic setup, isolates corr_levels as the variable
REM   - Standard CorrBlock at fm=16 B=8 fits 5090 32GB (~26 GB)
REM   - Per step ~250-400 ms, 50 epoch ~45 min
REM Pass criteria: val EPE < 2.0 by epoch 25
REM Fail criteria: val EPE stays ~2.6 throughout -> need other hypothesis
REM =============================================================================
...
set EXP_NAME=paper1_v3_1_4_p4_test_std_b8
...
python scripts\phase1\train_phase1.py ^
    --model-config configs\models\raft_dvc_1_4_p4_r4.yaml ^
...
echo Healthy:   val EPE drops below 2.0 by epoch 25
